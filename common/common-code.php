  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav container justify-content-end">
      ...
      <!-- li for seach end ^ -->
       ...
       <li class="nav-item">
        <a class="nav-link" id=""><i class="fas fa-globe"></i></a>

          <div class="container-fluid notification-container" id="notification">     
          

            <div class="row" id="notificationData">
      ...
      <li class="nav-item">
        <a class="nav-link" id="showNotification"><i class="fas fa-user-friends "></i></a>
      </li>
       ...
       <li class="nav-item dropdown active">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../img/logo.png" width="27" height="27" style="border-radius: 50%;"> </a>
