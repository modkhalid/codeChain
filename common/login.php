...
if(isset($_POST['login'])){
	...
	$cprypted_password=crypt($modl29_password,'$2a$10$JpwzO05wgRHG0dhuaPBaOU$');
	$sql="SELECT * FROM usermodl29 where username='$modl29_username' and password='$modl29_password'";
